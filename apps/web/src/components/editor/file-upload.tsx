...
import { getFilCDNService, isFilCDNConfigured, UploadResult } from "@/lib/filcdn";
      ...
      <Card className="border-dashed border-2 border-muted-foreground/25">
        <CardContent className="flex flex-col items-center justify-center p-6 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            To upload files to FilCDN, you need to configure your Filecoin Calibration testnet wallet.
          </p>
        ...
        {isUploading ? (
          <div className="text-center space-y-4">
            ...
            <p className="text-xs text-muted-foreground">
              {uploadProgress < 40 ? 'Initializing FilCDN...' : 
               uploadProgress < 80 ? 'Uploading to Filecoin...' : 
               'Finalizing deal...'}
            </p>
          </div>
        ) : (
