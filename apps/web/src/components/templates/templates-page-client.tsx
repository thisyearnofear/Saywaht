...
export function TemplatesPageClient({ initialCategories }: TemplatesPageClientProps) {
    ...
    <div className="h-screen bg-background text-foreground flex flex-col overflow-hidden">
      ...
      <main className={cn(
        ...
        <div className={cn(
          ...
          {/* Template Browser Container - Pass server-fetched categories */}
          <div className={cn(
            ...
            <TemplateBrowser initialCategories={initialCategories} />
          </div>
